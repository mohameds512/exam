				...
				<div class="container-fluid">
					<div class="main-header-left ">
						...
						<div class="main-header-center mr-3 d-sm-none d-md-none d-lg-block">
							<input class="form-control" plac    eholder="Search for anything..." type="search"> <button class="btn"><i class="fas fa-search d-none d-md-block"></i></button>
						</div>
					</div>
						...
						<div class="nav nav-item  navbar-nav-right ml-auto">
                            ...
                            @if (Auth::check())
                                <div class="dropdown main-profile-menu nav nav-item nav-link">
                                    <a class="profile-user d-flex" href=""><img alt="" src="{{Auth::user()->img_path}}"></a>
                                    <div class="dropdown-menu">
                                        <div class="main-header-profile bg-primary p-3">
                                            <div class="d-flex wd-100p">
                                                <div class="main-img-user"><img alt="" src="{{Auth::user()->img_path}}" class=""></div>
                                                <div class="mr-3 my-auto">
                                                    <h6> {{Auth::user()->name}} </h6><span>{{Auth::user()->role_name}}</span>
                                                </div>
                                            </div>
                                        </div>
                                        <a class="dropdown-item" href="{{ route('profile' , Auth::user()->id ) }}"><i class="bx bx-user-circle"></i>Profile</a>
                            ...
                            @else
                                <div style="margin-top: 0.5rem">
                                    <a href="{{ route('login') }}"  > {{ trans('main_trans.login') }} </a>
                                </div>
                            @endif
